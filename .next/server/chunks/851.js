...
var utilits = __webpack_require__(2373);
          ...
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
              ...
              children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
                ...
                className: "fn_title",
                children: "Join us as a community"
              }), /*#__PURE__*/jsx_runtime_.jsx("p", {
                className: "fn_desc",
                children: "Share Your Story, Find Strength, Embrace Humanity"
              })]
          ...
          children: /*#__PURE__*/jsx_runtime_.jsx("div", {
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("p", {
                children: ["Copyright ", new Date().getFullYear(), " - Designed & Developed by", " ", /*#__PURE__*/jsx_runtime_.jsx("a", {
                  href: "thebajrangi.com",
                  target: "_blank",
                  rel: "noreferrer",
                  children: "Bajrangi Token"
                })]
              })
            })
          })
    ...
    children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
              ...
              children: [/*#__PURE__*/jsx_runtime_.jsx("a", {
                ...
                children: [/*#__PURE__*/jsx_runtime_.jsx("li", {
                  children: /*#__PURE__*/jsx_runtime_.jsx((link_default()), {
                    href: "/",
                    children: "Home Static"
                  })
                }), /*#__PURE__*/jsx_runtime_.jsx("li", {
                  children: /*#__PURE__*/jsx_runtime_.jsx((link_default()), {
                    href: "/kenburns",
                    children: "Full Kenburns"
                  })
                }), /*#__PURE__*/jsx_runtime_.jsx("li", {
                  children: /*#__PURE__*/jsx_runtime_.jsx((link_default()), {
                    href: "/half-kenburns",
                    children: "Half Kenburns"
                  })
                }), /*#__PURE__*/jsx_runtime_.jsx("li", {
                  children: /*#__PURE__*/jsx_runtime_.jsx((link_default()), {
                    href: "/half-slider",
                    children: "Half Slider"
                  })
                })]
              })]
            }), /*#__PURE__*/jsx_runtime_.jsx("li", {
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: "nf_left",
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("p", {
            children: ["Copyright 2022- Designed & Developed by", " ", /*#__PURE__*/jsx_runtime_.jsx("a", {
              href: "thebajrangi.com",
              target: "_blank",
              children: "Bajrangi Token"
            })]
...
const Layout = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(external_react_.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)((head_default()), {
    ...
    }), /*#__PURE__*/jsx_runtime_.jsx(popup_VideoPopup, {}), /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(layout_Header, {}), /*#__PURE__*/jsx_runtime_.jsx("div", {
        ...
        children: children
      }), /*#__PURE__*/jsx_runtime_.jsx(layout_Footer, {}), /*#__PURE__*/jsx_runtime_.jsx(layout_ScrollTop, {})]
    }), /*#__PURE__*/jsx_runtime_.jsx("div", {
...
const imgToSVG = () => {
  document.querySelectorAll("img.fn__svg").forEach(el => {
    // Get the "id", "class", and "src" attributes of the image
    const imgID = el.getAttribute("id");
    const imgClass = el.getAttribute("class");
    const imgURL = el.getAttribute("src"); // Fetch the image URL

    fetch(imgURL).then(data => data.text()).then(response => {
      // Parse the response into an XML document
      const parser = new DOMParser();
      const xmlDoc = parser.parseFromString(response, "text/html");
      let svg = xmlDoc.querySelector("svg"); // Set "id" attribute if imgID is defined

      if (typeof imgID !== "undefined") {
        svg.setAttribute("id", imgID);
      } // Set "class" attribute if imgClass is defined


      if (typeof imgClass !== "undefined") {
        svg.setAttribute("class", imgClass + " replaced-svg");
      } // Remove the "xmlns:a" attribute from the SVG


      svg.removeAttribute("xmlns:a"); // Replace the original image element with the SVG element
